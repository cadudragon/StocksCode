...
export class UserClient {
    ...
    create(command: CreateUserCommand): Promise<FileResponse> {
    ...
    login(username: string | null | undefined, password: string | null | undefined, email: string | null | undefined): Promise<FileResponse> {
